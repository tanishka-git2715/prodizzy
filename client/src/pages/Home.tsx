        ...
        >
          ...
          >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white/5 border border-white/10 hover:bg-white/10 text-white font-medium py-3 px-4 rounded-lg transition-colors mb-6 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {googleRedirecting ? (
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-[#0D0E0F] px-2 text-white/40">or continue with email</span>
              </div>
            </div>
